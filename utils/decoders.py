    ...
    for n in range(len(outLogProbs)):
        ...
        for t in range(maxT):
            ...
            for labeling in bestLabelings:
                ...
                curr.entries[labeling].logPrTotal = log_add(curr.entries[labeling].logPrTotal,
                                                            log_add(logPrBlank, logPrNonBlank))
                ...
                for c in prunedChars:
                    ...
                    curr.entries[newLabeling].logPrNonBlank = log_add(curr.entries[newLabeling].logPrNonBlank,
                                                                      logPrNonBlank)
