...
def parse_args():
    ...
    parser.add_argument('--curriculum_weight', type=str, default="../3e_xcpan/checkpoints/neg255g/train-step_0034-Acc_0.997.pt")
    parser.add_argument('--weight', type=str, default="../3e_xcpan/checkpoints/neg63_1e5/train-step_0010-Acc_0.990.pt")
    ...
    parser.add_argument('--threshold', type=float, default=0.955)
    # Dir
    parser.add_argument('--logits_h5_dir', type=str, default='../3e_pretrain/logits_neg63.h5')
